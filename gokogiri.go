...
import (
	"github.com/matislovas/gokogiri/html"
...
found in the github.com/matislovas/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
